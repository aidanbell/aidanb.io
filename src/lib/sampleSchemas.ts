...
export const sampleSchemas: SampleSchema[] = [
  ...
  },
  {
    ...
    schema: {
      ...
      description:
        "Tell us what is working and what is not. Use Custom control → Star rating to swap the number input.",
      fields: [
        {
          name: "rating",
          type: "number",
  ...
  },
  {
    ...
    schema: {
      ...
      description: "Shows pattern validation, default values, and disabled fields.",
      fields: [
        {
          name: "workspaceId",
          type: "string",
