...
const principles = [
  ...
  },
  {
    ...
    body: 'For form-heavy products, I prefer shared schemas (Zod / JSON) that can drive UI, validation, and stay aligned with the API.',
  },
  {
  ...
  return (
    <section id="approach" className={sectionBorderClass}>
      ...
      <p className={`mt-4 ${mutedTextClass}`}>
        ...
        products — especially dashboards and form-heavy tools.
      </p>
