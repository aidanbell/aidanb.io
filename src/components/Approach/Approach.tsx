import { headingClass, mutedTextClass, sectionBorderClass } from "../../lib/styles";
  ...
  return (
    <section id="approach" className={sectionBorderClass}>
      ...
      <p className={`mt-4 ${mutedTextClass}`}>
        Where I spend a lot of my time lately: the interface layer of full-stack products. Dashboards, form-heavy tools,
        and WYSIWYG editors; all of these follow the same principles:
      </p>
      <ul className="mt-10 grid gap-6 sm:grid-cols-2">
        {principles.map((item) => (
          ...
          >
            ...
            <p className={`mt-2 text-sm leading-relaxed ${mutedTextClass}`}>{item.body}</p>
          </li>
        ))}
      </ul>
    </section>
