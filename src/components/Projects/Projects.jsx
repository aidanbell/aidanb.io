  ...
  return (
    <section id="work" className={sectionBorderClass}>
      ...
      <p className={`mt-4 ${mutedTextClass}`}>
        Selected projects across the stack — with a through-line of forms,
        editors, and data-heavy interfaces.
      </p>
          ...
          return (
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-2">
                ...
                <span className={`pt-1.5 text-xs ${mutedTextClass}`}>
                  {project.role}
                </span>
              </div>
              ...
              <ul
                className={`mt-4 list-disc space-y-1 pl-5 text-sm ${mutedTextClass}`}
              >
