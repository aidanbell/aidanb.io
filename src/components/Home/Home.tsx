...
export default function Home() {
  return (
    <section id="home" className="relative overflow-hidden border-b border-neutral-200 dark:border-neutral-800">
      <div
        aria-hidden="true"
      ...
      <div className={`${sectionClass} relative flex min-h-[calc(100vh-3.5rem)] flex-col justify-center`}>
        ...
        >
          Full-stack engineer with a focus on complex dashboards and form-heavy UIs.
        </p>
